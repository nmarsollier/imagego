...
var sources = []*ast.Source{
	{Name: "../schema.graphqls", Input: `type Image @key(fields: "id") {
  id: String!
  image: String!
}
...
func (ec *executionContext) field_Query_getImage_argsSize(
	...
	if tmp, ok := rawArgs["size"]; ok {
		return ec.unmarshalNImageSize2githubᚗcomᚋnmarsollierᚋimagegoᚋgraphᚋmodelᚐImageSize(ctx, tmp)
	}
...
func (ec *executionContext) _Entity_findImageByID(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.(*Image)
	fc.Result = res
	return ec.marshalNImage2ᚖgithubᚗcomᚋnmarsollierᚋimagegoᚋgraphᚋmodelᚐImage(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNImage2githubᚗcomᚋnmarsollierᚋimagegoᚋgraphᚋmodelᚐImage(ctx context.Context, sel ast.SelectionSet, v Image) graphql.Marshaler {
	return ec._Image(ctx, sel, &v)
}

func (ec *executionContext) marshalNImage2ᚖgithubᚗcomᚋnmarsollierᚋimagegoᚋgraphᚋmodelᚐImage(ctx context.Context, sel ast.SelectionSet, v *Image) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) unmarshalNImageSize2githubᚗcomᚋnmarsollierᚋimagegoᚋgraphᚋmodelᚐImageSize(ctx context.Context, v interface{}) (ImageSize, error) {
	var res ImageSize
	err := res.UnmarshalGQL(v)
	return res, graphql.ErrorOnPath(ctx, err)
}

func (ec *executionContext) marshalNImageSize2githubᚗcomᚋnmarsollierᚋimagegoᚋgraphᚋmodelᚐImageSize(ctx context.Context, sel ast.SelectionSet, v ImageSize) graphql.Marshaler {
	return v
}
